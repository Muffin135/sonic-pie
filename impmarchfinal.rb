...
breathing = "C:/Users/Lionel Quintanilla/Desktop/vader.wav"
# Custom sample that replicates TIE fighter flying overhead
tie_fighter = "C:/Users/Lionel Quintanilla/Desktop/tie.wav"
...
# Paramaterised function that can be used to edit the drop (c is for the beat, d is for the amplitude)
define :editable_drop do |c,d|
  1.times do
    # Uses the BPM assigned above
    use_bpm b
    # Plays the verse as was previously described in the first_verse function
    main_theme
    # Adds 'c' to variable 'b' (Increases BPM)
    b = b+c
    # Adds 'd' to variable 'a' (Increases amplitude)
    a = a+d
...
live_loop :violin do
  sample :ambi_soft_buzz, sustain: 4, amp: 1.5
  sleep 4
end
